...
X_train_scaled = torch.tensor(X_train_scaled, dtype=torch.float32).unsqueeze(1).to(device)
X_test_scaled = torch.tensor(X_test_scaled, dtype=torch.float32).unsqueeze(1).to(device)
